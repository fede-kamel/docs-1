...
| :--- | :--- | :---: | :---: | :---: | :---: | :---: |
| [`OCIGenAIEmbeddings`](https://reference.langchain.com/python/langchain-oci) | [`langchain-oci`](https://reference.langchain.com/python/langchain-oci) | beta | ✅ | ✅ | ![PyPI - Downloads](https://img.shields.io/pypi/dm/langchain-oci?style=flat-square&label=%20) | ![PyPI - Version](https://img.shields.io/pypi/v/langchain-oci?style=flat-square&label=%20) |
...
For detailed documentation of all `OCIGenAIEmbeddings` features and configurations, head to the [API reference](https://reference.langchain.com/python/langchain-oci).

...
See [usage example](/oss/integrations/text_embedding/oci_generative_ai).
...
For comprehensive guides covering all features, see the [langchain-oci tutorials](https://github.com/oracle/langchain-oracle/tree/main/libs/oci/tutorials):

| Tutorial | Level | Topics |
|----------|-------|--------|
| [01: Getting Started](https://github.com/oracle/langchain-oracle/tree/main/libs/oci/tutorials/01-getting-started) | Beginner | Authentication, basic chat, providers |
| [02: Vision & Multimodal](https://github.com/oracle/langchain-oracle/tree/main/libs/oci/tutorials/02-vision-and-multimodal) | Beginner | Image analysis, PDF, video, audio |
| [03: Building AI Agents](https://github.com/oracle/langchain-oracle/tree/main/libs/oci/tutorials/03-building-ai-agents) | Intermediate | ReAct agents, tools, memory |
| [04: Tool Calling Mastery](https://github.com/oracle/langchain-oracle/tree/main/libs/oci/tutorials/04-tool-calling-mastery) | Intermediate | Parallel tools, workflows |
| [05: Structured Output](https://github.com/oracle/langchain-oracle/tree/main/libs/oci/tutorials/05-structured-output) | Intermediate | Pydantic schemas, JSON modes |
| [07: Async for Production](https://github.com/oracle/langchain-oracle/tree/main/libs/oci/tutorials/07-async-for-production) | Advanced | ainvoke, astream, FastAPI |
| [09: Provider Deep Dive](https://github.com/oracle/langchain-oracle/tree/main/libs/oci/tutorials/09-provider-deep-dive) | Specialized | Meta, Gemini, Cohere, xAI specifics |
| [10: Embeddings](https://github.com/oracle/langchain-oracle/tree/main/libs/oci/tutorials/10-embeddings) | Specialized | Text & image embeddings, RAG |

---

## Additional Resources

- [API Reference](https://python.langchain.com/api_reference/oci/index.html)

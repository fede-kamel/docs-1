...
- **Using attachments from traces**: Similar to [offline evaluations with attachments](/langsmith/evaluate-with-attachments), you can use attachments from your traces in online evaluations:
    ...
    1. Add a template variable for the attachment(s) you want to include from the trace.
